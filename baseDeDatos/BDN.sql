...
--
-- Host: 127.0.0.1    Database: inventarioescuela
-- ------------------------------------------------------
...
CREATE TABLE `movimiento` (
  ...
  KEY `FK_ALMACENAMIENTO_ANTERIOR_idx` (`ID_ALMACENAMIENTO_ANTERIOR`),
  KEY `FK_MATERIAL_MOVIMIENTO_idx` (`ID_MATERIAL`),
  KEY `FK_ALMACENAMIENTO_NUEVO_idx` (`ID_ALMACENAMIENTO_NUEVO`),
  CONSTRAINT `FK_ALMACENAMIENTO_ANTERIOR` FOREIGN KEY (`ID_ALMACENAMIENTO_ANTERIOR`) REFERENCES `almacenamiento` (`ID_ALMACENAMIENTO`),
  CONSTRAINT `FK_ALMACENAMIENTO_NUEVO` FOREIGN KEY (`ID_ALMACENAMIENTO_NUEVO`) REFERENCES `almacenamiento` (`ID_ALMACENAMIENTO`),
  CONSTRAINT `FK_MATERIAL_MOVIMIENTO` FOREIGN KEY (`ID_MATERIAL`) REFERENCES `material` (`ID_MATERIAL`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `notificaciones` (
  ...
  `REFERENTE_NOMBRE` varchar(100) DEFAULT NULL,
  `ACCION` varchar(50) NOT NULL,
  `OBJETO_NOMBRE` varchar(100) NOT NULL,
  `OBJETO_TIPO` varchar(50) DEFAULT NULL,
  `UBICACION_ANTERIOR` varchar(100) DEFAULT NULL,
  `UBICACION_NUEVA` varchar(100) DEFAULT NULL,
  `CANTIDAD` int DEFAULT NULL,
  `FECHA` datetime DEFAULT CURRENT_TIMESTAMP,
  `DESCRIPCION` text,
  PRIMARY KEY (`ID_NOTIFICACION`),
  KEY `ID_REFERENTE` (`ID_REFERENTE`),
  CONSTRAINT `notificaciones_ibfk_1` FOREIGN KEY (`ID_REFERENTE`) REFERENCES `usuario` (`ID_USUARIO`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pc` (
  ...
  KEY `FK_PLACA_idx` (`ID_PLACA`,`ID_PROCESADOR`,`ID_RAM`,`ID_DISCO`,`ID_FUENTE`,`ID_GABINETE`,`ID_TECLADO`,`ID_MONITOR`),
  KEY `FK_RAM_idx` (`ID_RAM`),
  KEY `FK_DISCO_idx` (`ID_DISCO`),
  KEY `FK_EXPANSION_idx` (`ID_EXPANSION`),
  CONSTRAINT `FK_DISCO` FOREIGN KEY (`ID_DISCO`) REFERENCES `material` (`ID_MATERIAL`),
  CONSTRAINT `FK_EXPANSION` FOREIGN KEY (`ID_EXPANSION`) REFERENCES `material` (`ID_MATERIAL`),
  ...
  CONSTRAINT `FK_RAM` FOREIGN KEY (`ID_RAM`) REFERENCES `material` (`ID_MATERIAL`),
...
